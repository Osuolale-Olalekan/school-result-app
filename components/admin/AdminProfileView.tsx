    ...
    <div className="space-y-5 max-w-3xl w-full min-w-0">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="px-4 sm:px-6 pb-6">
          <div className="-mt-12 mb-4 flex flex-col xs:flex-row items-start xs:items-end gap-3">
            <div className="w-20 h-20 rounded-2xl border-4 border-white bg-amber-100 flex items-center justify-center text-amber-700 text-2xl font-bold shadow-sm overflow-hidden flex-shrink-0">
            ...
            <div className="pb-1 min-w-0">
              <h2 className="text-lg sm:text-xl font-bold text-gray-900 break-words leading-tight mb-1">{fullName}</h2>
              <span className="text-xs px-2 py-0.5 rounded-full bg-amber-100 text-amber-700 font-medium inline-block">
                Administrator
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={label} className="flex items-start gap-3 p-3 bg-gray-50 rounded-xl min-w-0">
