...
import {
  ...
  CreditCard, UserCheck, RefreshCw, Trash2, X,
} from "lucide-react";
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        {notifications.length > 0 && (
          <button
            ...
            disabled={isClearing}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold bg-red-50 text-red-500 border border-red-200 hover:bg-red-100 transition-colors disabled:opacity-50"
          >
            {isClearing
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1 flex-shrink-0 mt-1">
                          ...
                          <button
                            onClick={(e) => handleClearOne(e, n._id)}
                            className="p-1 rounded-lg opacity-0 group-hover:opacity-100 transition-all text-gray-400 hover:text-red-500 hover:bg-red-50"
