...
//         const allClassSubjects = assignment.class.subjects ?? [];

//         const relevantSubjects = hasNoDepartment
//           ? allClassSubjects
//           : allClassSubjects.filter(
//               (s) =>
...
//         const savedScoreMap = new Map(
//           report.subjects.map((s) => [s.subject, s]),
//         );
...
//       draft.attendance.schoolDaysOpen === 0
//     ) {
...
//   student: Student;
//   draft?: ReportDraft;
//   selectedAssignment: ClassAssignment;
//   isExpanded: boolean;
//   saving: boolean;
//   onToggle: () => void;
//   onUpdateScore: (
...
//   // Only show AI suggest when: editable, not yet submitted, comment is empty
//   const canSuggestComment =
//     !isLocked && !isSubmitted && !draft?.teacherComment?.trim();

//   async function suggestComment() {
//     if (!draft || generatingComment) return;
//     setGeneratingComment(true);
//     try {
//       const activeTerm = selectedAssignment.session.terms.find(
//         (t) => t.status === "active",
//       );
//       const res = await fetch("/api/teacher/results/ai-comment", {
//         method: "POST",
...
//                   s.testScore +
//                   s.examScore +
//                   (s.hasPractical ? s.practicalScore : 0),
//                 0,
//               );
...
//                               value={
//                                 score.testScore === 0 ? "" : score.testScore
//                               }
//                               readOnly={isLocked}
//                               onChange={(e) => {
//                                 if (isLocked) return;
...
//                               value={
//                                 score.examScore === 0 ? "" : score.examScore
//                               }
//                               readOnly={isLocked}
//                               onChange={(e) => {
//                                 if (isLocked) return;
...
//                 Teacher&apos;s Comment
//               </label>
//               {/* AI Suggest — only when editable, not submitted, and comment is empty */}
//               {canSuggestComment && (
//                 <button
...
//                 generatingComment
//                   ? "Generating comment..."
//                   : "e.g. Excellent performance this term..."
//               }
//               className={inputClass("w-full px-3 py-2 rounded-xl border")}
//             />
//           </div>
